...
def add_capture_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--capture-start", default="запись", help="Phrase that starts command capture.")
    parser.add_argument("--capture-submit", default="конец", help="Phrase that submits captured command.")
    parser.add_argument("--capture-cancel", default="отмена", help="Phrase that cancels captured command.")
    parser.add_argument(
